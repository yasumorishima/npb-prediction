...
> **注意:** Marcel法は過去3年間（2023-2025）のNPBデータに基づく純粋な統計予測です。MLB移籍・引退・怪我などの非統計的要因は考慮していません。そのため、既にNPBを離れた選手（MLB移籍組など）が予測に含まれる場合があります。
...
| 山本由伸 | オリックス* | 2.15 | 1.04 | 149 |
| 宮城大弥 | オリックス | 2.29 | 1.01 | 139 |

> **\*注: 山本由伸は2024年よりMLB（ロサンゼルス・ドジャース）に移籍しており、2024-2025年のNPBデータは存在しません。** Marcel法は過去3年（2023/2024/2025）のいずれかにデータがあれば予測対象になるため、2023年のNPB成績（ERA 1.21、164回、169奪三振）1年分のみをベースに予測が算出されています。NPB時代の成績が圧倒的だったため、リーグ平均への回帰を経てもなおTOP5に入っています。実際にNPBで投げる可能性は現時点ではなく、あくまで「NPBの過去データが入力された場合の予測値」としてお読みください。
