...
| 確認 | 結果 |
|---|---|
| 実測残差 sd ÷ 当てていた σ（2018-2025 の 8 シーズン） | 打者 0.54〜0.71 / 投手 0.57〜0.71（**8 年すべて 1 未満**） |
...
⚠️ **`data/projections/foreign_*_2026.csv` の区間は旧方式（標本分位点）のまま。** 凍結したので再生成していない。実測で中心が +0.0025 OPS 非対称、95%/80% の幅の比が 1.521（閉じた形なら 1.5294）。
