...
| 80% / 95% 区間の被覆率（名目 0.80 / 0.95） | 旧（平の σ） | 新 |
|---|---|---|
| 打者 2025 | 0.988 / 1.000 | 0.876 / 0.976 |
| 打者 2026 | 0.954 / 0.992 | **0.840 / 0.947** |
| 投手 2025 | 0.986 / 1.000 | 0.847 / 0.993 |
| 投手 2026 | 0.950 / 0.992 | **0.860 / 0.967** |

同時に区間の作り方の不具合を 2 件直した。**区間は `stan` を中心に作られていたのに公表する点推定は BMA 合成の `bayes_*`** だった（中心が点推定からずれる）。また**正規分布の分位点を固定 seed の 5,000 draws から取っていた**ため、標本分位点のずれが全選手に同じ向きで乗っていた（seed 42 で −0.0018 OPS）。どちらも点推定の値は変えていない。
