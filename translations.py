...
TEXTS: dict[str, dict[str, str]] = {
    "ja": {
        ...
        "data_years_legend": "注欄の見方：⚠️1年＝NPBデータが1年のみ（予測値はリーグ平均寄りになりやすい）　📊2年＝NPBデータが2年のみ（やや補正あり）",
    ...
    "en": {
        ...
        "data_years_legend": "Column guide: ⚠️1yr = only 1 yr of NPB data (projection anchored to league avg)　📊2yr = 2 yrs of NPB data (moderate regression)",
